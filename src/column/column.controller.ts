...
export class ColumnController {
    ...
    @ApiResponse({
        status: 200, description: 'Return column by id.', schema: {
            type: 'object',
            properties: {
                id: {
                    type: "integer",
                ...
                author_: {
                    ...
                    example: {
                        ...
                        "password": "$2b$10$.275k5seNCfHq1CE0EmPDOJkozr2QEJNFH8JSaYAdErmqN.MRXv9G",
                        "access_token": null
                    },
                },
                cards: {
    ...
    @ApiResponse({
        status: 201, description: 'The column has been successfully created.', schema: {
            type: 'object',
            properties: {
                id: {
                    type: "integer",
    ...
    async create(@Body() column: CreateColumnDto, @UserDecorator() user: UserEntity) {
    ...
    @ApiResponse({
        status: 200, description: 'The column has been successfully updated.', schema: {
            type: 'object',
            properties: {
                id: {
                    type: "integer",
